...
function brandMarkup() {
  // Genericized fork: render no brand footer. Drops the visible "Superpowers"
  // branding and, importantly, avoids the remote primeradiant.com brand-image
  // request (a version-tagged beacon) so the companion never phones home.
  return '';
}
